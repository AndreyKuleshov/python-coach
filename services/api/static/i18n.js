...
window.Coach.UI = {
  en: {
    ...
    hintError: "Could not get a hint. Try again.",
    themeLight: "Light",
    themeDark: "Dark",
    themeLightAriaLabel: "Switch to light mode",
    themeDarkAriaLabel: "Switch to dark mode",
    chatTitle: "Lesson helper",
    chatOpen: "💬 Ask about this lesson",
    chatClose: "Close",
    chatIntro: "Paste a piece of the lesson for a more detailed explanation.",
    chatExcerptLabel: "Lesson excerpt",
    chatQuestionLabel: "Your question (optional)",
    chatSend: "Explain",
  ...
  ru: {
    ...
    hint: "Подсказка",
    hintLoading: "Думаю…",
    hintError: "Не удалось получить подсказку. Попробуйте снова.",
    themeLight: "Светлая",
    themeDark: "Тёмная",
    themeLightAriaLabel: "Переключить на светлую тему",
    themeDarkAriaLabel: "Переключить на тёмную тему",
    chatTitle: "Помощник по уроку",
    chatOpen: "💬 Спросить про урок",
    chatClose: "Закрыть",
    chatIntro: "Вставьте фрагмент урока, чтобы получить более подробное объяснение.",
    chatExcerptLabel: "Фрагмент урока",
    chatQuestionLabel: "Ваш вопрос (необязательно)",
    chatSend: "Объяснить",
    chatSending: "Думаю…",
